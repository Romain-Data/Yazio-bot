...
class MammouthService:
    ...
    def analyze_text(self, text: str, local_time: str = None) -> RepasAnalysis:
        ...
        - Extraire ou estimer la durée de l'effort physique actif réel en minutes dans `duree_minutes` (ex: 180, 90, 30). N'inclus pas les temps de repos passifs ou de simple présence sur place (par exemple si l'utilisateur dit "5h passés là-bas dont 3h dans l'eau", retiens 3h soit 180 minutes).
